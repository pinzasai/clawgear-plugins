---
name: de-ai-ify
description: Remove AI-generated jargon and restore human voice to any piece of writing. Detects 47 specific AI patterns across 5 categories (hedge phrases, corporate filler, robotic structure, cliches, buzzwords), scores content on a 0-10 human-ness scale, rewrites with tracked changes, and outputs a change log. Use when polishing AI-generated content before publishing — blog posts, social media, marketing copy, or any text that needs to sound like a human wrote it.
---
